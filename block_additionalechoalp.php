...
class block_additionalechoalp extends block_base {

    function init() {
        $this->title = get_string('pluginname', 'block_additionalechoalp');
    }
    ...
    function get_content() {
        ...
        // Set Echo link
        $link = '/blocks/additionalechoalp/viewecho.php?courseid=' . $courseid . '&blockid=' . $this->instance->id;

        // Build block content
        $content = '';
        $content .= html_writer::start_tag('p');
        $content .= $this->config->explanation;
