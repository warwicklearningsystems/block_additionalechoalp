 ...
 * Echo ALP block
 *
 * @package    block_additionalechoalp
...
$settings->add(new admin_setting_heading('additionalechoalpblock',
                                         "Echo ALP block",
...
$settings->add( new admin_setting_configselect("additionalechoalp/ltitool",
                                                "LTI tool",
...
$settings->add( new admin_setting_configselect("additionalechoalp/ltiopen",
    "Launch container",
